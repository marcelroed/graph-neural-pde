...
def get_image_opt(opt):
    ...
    if opt['im_dataset'] == 'MNIST':
        ...
        opt['pixel_cat'] = 5  # 10 #2 #[2 for binary_sigmoid, 10 for'10catM2','10catlogits' ]
        opt[
            'pixel_loss'] = '10catkmeans'  # '10catM2' #'10catkmeans' #'10catM2' #'10catlogits' #  ['binary_sigmoid','10catM2','10catlogits','MSE']
